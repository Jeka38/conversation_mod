...
public final class FilterPack {
    ...
    public static List<NamedFilter> getFilterPack(Context context) {
        List<NamedFilter> filters = new ArrayList<>();
    ...
    public static NamedFilter getStarLitFilter(Context context) {
        Point[] rgbKnots;
    ...
    public static NamedFilter getBlueMessFilter(Context context) {
        Point[] redKnots;
    ...
    public static NamedFilter getAweStruckVibeFilter(Context context) {
        Point[] rgbKnots;
        Point[] redKnots;
        Point[] greenKnots;
        Point[] blueKnots;
    ...
    public static NamedFilter getLimeStutterFilter(Context context) {
        Point[] blueKnots;
    ...
    public static NamedFilter getNightWhisperFilter(Context context) {
        Point[] rgbKnots;
        Point[] redKnots;
        Point[] greenKnots;
        Point[] blueKnots;
    ...
    public static NamedFilter getAmazonFilter(Context context) {
        Point[] blueKnots;
        ...
        NamedFilter filter = new NamedFilter(context.getString(R.string.amazon));
        filter.addSubFilter(new ContrastSubFilter(1.2f));
        filter.addSubFilter(new ToneCurveSubFilter(null, null, null, blueKnots));
        return filter;
    }

    public static NamedFilter getAdeleFilter(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.adele));
        filter.addSubFilter(new SaturationSubFilter(-100f));
        return filter;
    }

    public static NamedFilter getCruzFilter(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.cruz));
        filter.addSubFilter(new SaturationSubFilter(-100f));
    ...
    public static NamedFilter getMetropolis(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.metropolis));
    ...
    public static NamedFilter getAudreyFilter(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.audrey));
    ...
    public static NamedFilter getRiseFilter(Context context) {
        Point[] blueKnots;
        Point[] redKnots;
        ...
        NamedFilter filter = new NamedFilter(context.getString(R.string.rise));
    ...
    public static NamedFilter getMarsFilter(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.mars));
        filter.addSubFilter(new ContrastSubFilter(1.5f));
        filter.addSubFilter(new BrightnessSubFilter(10));
        return filter;
    }

    public static NamedFilter getAprilFilter(Context context) {
        Point[] blueKnots;
        Point[] redKnots;
        ...
        NamedFilter filter = new NamedFilter(context.getString(R.string.april));
        filter.addSubFilter(new ContrastSubFilter(1.5f));
    ...
    public static NamedFilter getHaanFilter(Context context) {
        Point[] greenKnots;
        greenKnots = new Point[3];
        greenKnots[0] = new Point(0, 0);
        ...
        NamedFilter filter = new NamedFilter(context.getString(R.string.haan));
        filter.addSubFilter(new ContrastSubFilter(1.3f));
        filter.addSubFilter(new BrightnessSubFilter(60));
        filter.addSubFilter(new VignetteSubFilter(context, 200));
    ...
    public static NamedFilter getOldManFilter(Context context) {
        NamedFilter filter = new NamedFilter(context.getString(R.string.oldman));
        filter.addSubFilter(new BrightnessSubFilter(30));
    ...
    public static NamedFilter getClarendon(Context context) {
        Point[] redKnots;
        Point[] greenKnots;
        Point[] blueKnots;
        ...
        NamedFilter filter = new NamedFilter(context.getString(R.string.clarendon));
        filter.addSubFilter(new ContrastSubFilter(1.5f));
        filter.addSubFilter(new BrightnessSubFilter(-10));
